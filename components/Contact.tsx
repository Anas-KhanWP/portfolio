...
const contactItems = [
  ...
  {
    label: "LinkedIn",
    value: socials.linkedin.split("/").pop(),
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {contactItems.map((item, i) => (
            <motion.a
              ...
              className="flex items-center gap-4 rounded-xl border border-white/5 bg-bg-secondary p-6 transition-all hover:border-accent/30 hover:bg-white/[0.03]"
